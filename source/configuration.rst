...
Manual configuration with the *Profiles* dialog
------------------------------------------------

To create new output profiles or edit existing ones, choose the menu item
:menuselection:`Build --> Define Output Profiles...`, which invokes the *Profiles* dialog:
...
The *(La)TeX* tab allows to define:
...
The *Postprocessor* tab page allows to define tools, which should be run
...
The *Viewer* tab page allows to define the applications used to view the
...
The meaning of the fields for a command are:
